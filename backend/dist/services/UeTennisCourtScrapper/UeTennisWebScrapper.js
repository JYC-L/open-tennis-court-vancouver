...
class UeTennisScrapper {
     ...
     */
    writeJsonToDisk(filename = "availability.json") {
        return __awaiter(this, void 0, void 0, function* () {
            const folderPath = path_1.default.join(__dirname, "..", "uetennis");
            if (!fs_1.default.existsSync(folderPath)) {
                fs_1.default.mkdirSync(folderPath, { recursive: true });
            }
            const filePath = path_1.default.join(folderPath, filename);
            fs_1.default.writeFileSync(filePath, JSON.stringify(this.allAvailability, null, 2), "utf8");
